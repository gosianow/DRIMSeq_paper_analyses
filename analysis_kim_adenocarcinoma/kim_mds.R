...
metadata$colors <- ifelse(metadata$condition == "normal", "blue", "orange")

metadata$shortname <- paste0(metadata$Patient.ID, "_", metadata$condition)
...
pdf(paste0(dir_out, "kim_MDS.pdf"))
