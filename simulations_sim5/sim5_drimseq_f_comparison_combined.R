######################################################
## ----- sim5_drimseq_f_comparison_combined
## <<sim5_drimseq_f_comparison_combined.R>>
...
out_dir_plots_main <- "drimseq_0_3_3_f_comparison"

out_dir_plots <- paste0(out_dir_plots_main, "/", filter_method, "/")
...
for(i in 1:length(simulation_list)){
  ...
  for(j in 1:length(count_method_list)){
    ...
    comparison_out <- paste0(simulation, "/", out_dir_plots_main)
