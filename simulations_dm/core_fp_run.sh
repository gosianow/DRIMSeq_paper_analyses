...
R32 CMD BATCH --no-save --no-restore "--args rwd='$RWD' sim_name='' n=${n} nm=${nm} nd=0 prop=${prop} disp=${disp} pdf_width=18 pdf_height=10 fig_name='all_'" $RCODE/core_fp_plots_run.R $ROUT/core_fp_plots_run.Rout
