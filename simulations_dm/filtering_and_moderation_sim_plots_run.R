##############################################################################
## ----- filtering_and_moderation_sim_plots_run
## <<filtering_and_moderation_sim_plots_run.R>>
...
out_dir_res <- "filtering_and_moderation/run/"
out_dir_plots <- "filtering_and_moderation/"

feature_filter <- "max_features"
