...
for model in 'model_null_normal2' 'model_null_tumor1' 'model_null_tumor2'
do 
...
do 
  ...
  do
    ...
    R31 CMD BATCH --no-save --no-restore "--args rwd='$RWD' workers=2 count_method='${count_method}' model='${model}' dispersion_common=FALSE results_common=FALSE disp_mode_list='grid' disp_moderation_list='common'" $RCODE/kim_drimseq_0_3_1_run.R $ROUT/kim_drimseq_0_3_1_run_${model}_${count_method}_grid_common.Rout
