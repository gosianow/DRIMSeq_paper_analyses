...
write.table(est, paste0(out_dir, out_name, "est_moderation_real_", run,".txt"), quote = FALSE, sep = "\t", row.names = FALSE)
write.table(fp, paste0(out_dir, out_name, "fp_moderation_real_", run,".txt"), quote = FALSE, sep = "\t", row.names = FALSE)
