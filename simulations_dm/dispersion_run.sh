...
R32 CMD BATCH --no-save --no-restore "--args rwd='$RWD' sim_name='' n=${n} nm=${nm} nd=0 prop=${prop} disp=${disp} pdf_width=15 pdf_height=10 fig_name='all_'" $RCODE/dispersion_plots_run.R $ROUT/dispersion_plots_run.Rout
...
R32 CMD BATCH --no-save --no-restore "--args rwd='$RWD' sim_name='' n=${n} nm=${nm} nd=0 prop=${prop} disp=${disp} pdf_width=7 pdf_height=7 fig_name='6_1000_'" $RCODE/dispersion_plots_run.R $ROUT/dispersion_plots_run.Rout
