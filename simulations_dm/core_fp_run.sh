...
do
  ...
  do
    ...
    for prop in 'prop_q3_kim_kallisto_fcutoff' 'prop_q10_kim_kallisto_fcutoff' 'prop_q3_uniform' 'prop_q10_uniform'
    do 
...
R32 CMD BATCH --no-save --no-restore "--args rwd='$RWD' sim_name='' n=${n} nm=${nm} nd=0 prop=${prop} disp=${disp} pdf_width=20 pdf_height=10 fig_name='all_' out_dir='core_fp_auto_moderation' out_suffix='core_fp'" $RCODE/core_fp_plots_run.R $ROUT/core_fp_plots_run.Rout
...
R32 CMD BATCH --no-save --no-restore "--args rwd='$RWD' sim_name='' n=${n} nm=${nm} nd=0 prop=${prop} disp=${disp} pdf_width=7 pdf_height=7 fig_name='6_1000_' out_dir='core_fp_auto_moderation' out_suffix='core_fp'" $RCODE/core_fp_plots_run.R $ROUT/core_fp_plots_run.Rout
...
R32 CMD BATCH --no-save --no-restore "--args rwd='$RWD' sim_name='' n=${n} nm=${nm} nd=0 prop=${prop} disp=${disp} pdf_width=7 pdf_height=7 fig_name='3_1000_' out_dir='core_fp_auto_moderation' out_suffix='core_fp'" $RCODE/core_fp_plots_run.R $ROUT/core_fp_plots_run.Rout
